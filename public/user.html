							...
							<div class="col-xl-12 col-md-12">
								<div class="card justify-content-center">
									<div class="card-body d-flex">
										<div class="d-block">
											<img src="images/profile/pic1.jpg" class="avatar avatar-xxl border-primary rounded-circle" alt="">
										</div>
								...
								<div class="card">
									...
									<div class="card-footer border-0 pt-0">
										<div class="text-center border-0">
											<a href="javascript:void(0);" class="btn btn-block btn-primary btn-sm dlab-load-more" id="RecentActivity" rel="ajax/message.html">View More</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card">
									<div class="card-header d-block border-0 pb-0 ">
										<div class="d-flex justify-content-between">
											...
											<a class="icon-box icon-box-sm bg-primary" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M12 3C7.05 3 3 7.05 3 12C3 16.95 7.05 21 12 21C16.95 21 21 16.95 21 12C21 7.05 16.95 3 12 3ZM12 19.125C8.1 19.125 4.875 15.9 4.875 12C4.875 8.1 8.1 4.875 12 4.875C15.9 4.875 19.125 8.1 19.125 12C19.125 15.9 15.9 19.125 12 19.125Z" fill="white"></path>
													<path d="M16.3503 11.0251H12.9753V7.65009C12.9753 7.12509 12.5253 6.67509 12.0003 6.67509C11.4753 6.67509 11.0253 7.12509 11.0253 7.65009V11.0251H7.65029C7.12529 11.0251 6.67529 11.4751 6.67529 12.0001C6.67529 12.5251 7.12529 12.9751 7.65029 12.9751H11.0253V16.3501C11.0253 16.8751 11.4753 17.3251 12.0003 17.3251C12.5253 17.3251 12.9753 16.8751 12.9753 16.3501V12.9751H16.3503C16.8753 12.9751 17.3253 12.5251 17.3253 12.0001C17.3253 11.4751 16.8753 11.0251 16.3503 11.0251Z" fill="white"></path>
												</svg>										
									...
									<div class="card-footer border-0 pt-0">
										<div class="text-center border-0 pt-3">
											<a href="javascript:void(0);" class="btn btn-block btn-primary dlab-load-more btn-sm" id="RecentMessages" rel="ajax/contacts.html">View More</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card">
									<div class="prot-blog">
										<div class="d-flex post justify-content-between align-items-center">
											...
											<div class="dropdown">
												<a href="javascrit:viod(0);" data-bs-toggle="dropdown" aria-expanded="false"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<h4 class="mb-0">
											<a href="post-details.html" class="text-bla"><svg class="me-1" width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<h4 class="mb-3">
											<a href="post-details.html" class="text-bla">
								...
								<div class="card">
									...
									<div class="card-body pt-2">
										<div class="d-flex align-items-center mb-4">
											...
											<div class="ms-3">
												<h5 class="mb-1"><a class="text-primary" href="activity.html">To Do</a></h5>
												<ul class="d-flex">
													<li class="me-3">5 Task Now</li>
													<li><svg width="6" class="me-3" height="7" viewBox="0 0 6 7" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="ms-3">
												<h5 class="mb-1"><a class="text-secondary" href="activity.html">In Progress</a></h5>
												<ul class="d-flex">
													<li class="me-3">5 Task Now</li>
													<li><svg width="6" class="me-3" height="7" viewBox="0 0 6 7" fill="none" xmlns="http://www.w3.org/2000/svg">
														<circle cx="3" cy="3.5" r="3" fill="#C4C4C4"></circle>
										...
										<div class="d-flex align-items-center">
											...
											<div class="ms-3">
												<h5 class="mb-1"><a class="text-success" href="activity.html">Completed</a></h5>
												<ul class="d-flex">
									...
									<div class="dz-scroll">
										<ul class="timeline-active">
											<li class="d-flex timeline-list">
												...
												<div class="panel">
													<a class="timeline-panel text-muted d-flex align-items-center mb-0" href="#">
														<h4 class="mb-0"><strong>Karen Hope</strong> moved task <strong class="text-primary">Jiade Projects</strong> </h4>
													</a>
											...
											<li class="d-flex timeline-list">
												...
												<div class="panel">
													<a class="timeline-panel text-muted d-flex align-items-center mb-0" href="#">
														<h4 class="mb-0" ><strong>Tony Soap </strong> commented at <strong class="text-primary"> Jiade Projects </strong></h4>
													</a>
													<span class="time py-0">Monday, June 31 2020</span>	
											...
											<li class="d-flex timeline-list pb-0">
												...
												<div class="panel">
													<a class="timeline-panel text-muted d-flex align-items-center mb-0" href="#">
														<h4 class="mb-0" ><strong>Samantha William </strong> add 4 files on  Jiade <strong class="text-danger">Projects </strong></h4>
													</a>
													<span class="time py-0">Monday, June 31 2020</span>	
												</div>
