    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?= base_url('business_home'); ?>" class="brand-logo d-flex align-items-center">
                <!-- Logo Image -->
                <img src="<?= base_url('assets/assets/img/illustrations/ARANEA_WHITE.png'); ?>" alt="ARANEA Logo" class="img-fluid" width="100" />

                <!-- Text Next to the Logo -->
                <span class="ms-2" style="font-size: 24px; font-weight: bold; color: #ffffff;">ARANEA</span>
            </a>
...
<li>
    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#upcomingFeatureModal" aria-expanded="false">
        ...
        <span class="nav-text">KYC Registration</span>
    </a>
</li>
...
<li>
    ...
    <ul aria-expanded="false">
        <li><a href="agent_add_customer">New Customer</a></li>
        <li><a href="agent_view_customer">View Customers</a></li>
        <li><a href="agent_add_customer_bank_account">Customer Bank Account</a></li>
    </ul>
</li>
...
<li>
    ...
    <ul aria-expanded="false">
        <li><a href="agent_product_master">Product Master</a></li>
        <li><a href="agent_view_products">View Products</a></li>
    </ul>
</li>
...
<li>
    ...
    <ul aria-expanded="false">
        <li><a href="agent_pre_costing">Pre Costing</a></li>
        <li><a href="agent_costing">Costing</a></li>
    </ul>
</li>
