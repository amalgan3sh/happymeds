        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <p>
                                <?= !empty($user['about_me']) ? $user['about_me'] : 'No description available.'; ?>
                            </p>
                        ...
                        <div class="card-body pt-0">
                            <div class="list-group-flush mt-4">
                                ...
                                <div class="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 border-0 border-bottom">
                                    ...
                                    <p class="mb-0">
                                        <?= '$' . number_format($totalPurchaseOrderAmount, 2) ?>
                                    </p>
                                </div>
                                <div class="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 border-0 border-bottom">
                                    <p class="mb-0">Best-Selling Product</p>
                                    <p class="mb-0">
                                        <?= $topSellingProducts[0]['ProductName'] ?? 'N/A' ?>
                                    </p>
                                </div>
                ...
                <?php if ($isKycVerified === 'pending') : ?>
                    <div class="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
                        <div class="card">
                            <div class="card-body text-center ai-icon text-primary">
                                <!-- Pending Icon -->
                                <svg id="pending-icon" class="my-2" viewBox="0 0 24 24" width="80" height="80" stroke="currentColor" stroke-width="1" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <?php elseif ($isKycVerified === 'in_process') : ?>
                        <div class="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
                            <div class="card">
                                <div class="card-body text-center ai-icon text-warning">
                                    <!-- In Process Icon -->
                                    <svg id="in-process-icon" class="my-2" viewBox="0 0 24 24" width="80" height="80" stroke="currentColor" stroke-width="1" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"></circle>
                                        <line x1="12" y1="6" x2="12" y2="12" stroke="currentColor" stroke-width="2"></line>
                                        <line x1="12" y1="12" x2="15" y2="9" stroke="currentColor" stroke-width="2"></line>
                        ...
                        <?php elseif ($isKycVerified === 'approved') : ?>
                            <div class="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
                                <div class="card">
                                    <div class="card-body text-center ai-icon text-success">
                                        <!-- Completed Icon -->
                                        <svg id="completed-icon" class="my-2" viewBox="0 0 24 24" width="80" height="80" stroke="currentColor" stroke-width="1" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"></circle>
                                            <path d="M9 12l2 2l4 -4" stroke="currentColor" stroke-width="2"></path>
                                        </svg>
                                        <h4 class="my-2">Your KYC has been successfully completed. You can now access all of Aranea’s features.</h4>
