        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    ...
                    <?php if ($kycExists && $user['kyc_verify'] != 'approved'){ ?>
                        ...
                        <?php } else if ($user['kyc_verify'] == 'approved'){ ?>
                            <div class="alert alert-success" role="alert">
                                KYC verification is Approved!
                            </div>
                            <?php } else if (!$kycExists) { ?>
...
<!-- Content body end -->
    ...
    ***********************************-->
    ...
    // Add event listener for Previous button (if needed)
    $('#smartwizard').on('click', '.sw-btn-prev', function() {
        // Reset any error messages or highlights when going back to previous step
    ...
    // Trigger validation on form submit (optional)
