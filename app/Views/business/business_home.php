									...
									<div class="card-body d-flex">
										...
										<div class="w-100 ps-4">
											<div class="d-flex justify-content-between">
												...
												<h5> <?= esc($user['user_type']) ?></h5>
													<!-- <span> London, United Kingdom </span>  -->
												</div>
												<!-- <div class="">
													<h4 class="card-title mb-1"> <?= session()->get('user_id'); ?> </h4>
													<h5> <?= session()->get('user_type'); ?> </h5>
											...
											<div class="d-flex flex-wrap pt-4">
												<div class="d-flex align-items-center pe-md-4 pe-2 mb-2">
													...
													<h5 class="font-w400 mb-0"><?= esc($user['email']) ?></h5>
												</div>
												<div class="d-flex align-items-center pe-md-4 pe-2 mb-2">
													<div class="pe-2">
														<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<h5 class="font-w400 mb-0"><?= esc($user['phone']) ?></h5>
												</div>
												<div class="d-flex align-items-center pe-md-4 pe-2 mb-2">
													<div class="pe-2">
														<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<h5 class="font-w400 mb-0"><?= esc($user['updated_at']) ?></h5>
												</div>
											</div>
										</div>
									</div>
