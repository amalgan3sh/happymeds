                            ...
                            <tbody>
                                <?php if (!empty($manufacturers)): ?>
                                    <?php foreach ($manufacturers as $index => $manufacturer): ?>
                                        <tr>
                                            <td><?= esc($index + 1) ?></td>
                                            <td><?= esc($manufacturer['firstname'] . ' ' . $manufacturer['lastname']) ?></td>
                                            <td><?= esc($manufacturer['email']) ?></td>
                                            <td><?= esc($manufacturer['phone']) ?></td>
                                            <td><?= esc($manufacturer['company_name']) ?></td>
                                            <td>
                                                <a href="<?= site_url('view_manufacturer/' . $manufacturer['user_id']) ?>" class="btn btn-info btn-sm">View</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else: ?>
