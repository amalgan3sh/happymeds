            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card mt-3">
                            <div class="card-header"> Invoice <strong>16/12/2023</strong> <span class="float-end">
                            ...
                            <div class="card-body">
                                <div class="row mb-5">
                                    ...
                                    <div class="mt-4 col-xl-6 col-lg-6 col-md-12 col-sm-12 d-flex justify-content-lg-end justify-content-md-strat justify-content-xs-start">
                                        <div class="row align-items-center">
											<div class="col-sm-9"> 
												<div class="brand-logo invoice-logo mb-3">
													<img class="logo-abbr me-2" width="110" src="./images/logo-full.png" alt="">
													<img class="logo-compact" width="110" src="./images/logo-white.png" alt="">
												</div>
