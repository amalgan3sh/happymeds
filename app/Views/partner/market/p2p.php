						...
						<div class="card">
							<div class="card-body">
								<div class="tab-content" id="nav-tabContent1">
													...
													<table id="example-history" class="table shadow-hover display  orderbookTable" style="min-width:845px">
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	<span class="badge badge-sm badge-danger">Sell</span> </td>
																<td>Limit</td>
																<td>-</td>
																<td><span class="badge badge-sm badge-light">- $100.00</span> </td>
																<td>576.76</td>
									...
									<div class="tab-pane fade show" id="nav-sell" role="tabpanel" aria-labelledby="nav-sell-tab">
