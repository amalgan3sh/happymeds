				...
				<div class="row">
							...
							<div class="card-body px-0 pt-0 dlab-scroll height370">
								...
								<div class="d-flex justify-content-between align-items-center market-preview">
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="javascript:void(0);"><h5 class="fs-14 font-w600 mb-0">ETH/USD</h5></a>
											<span class="fs-12 font-w400">January</span>
										</div>
									</div>	
									<div class="d-flex align-items-center">
								...
								<div class="d-flex justify-content-between align-items-center market-preview">
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="javascript:void(0);"><h5 class="fs-14 font-w600 mb-0">XRP/USD</h5></a>
											<span class="fs-12 font-w400">January</span>
										</div>
									</div>	
									<div class="d-flex align-items-center">
					...
					<div class="col-xl-3 col-xxl-4 col-sm-6 my-order-ile-2">
						<div class="card trade-history">
							...
							<div class="card-footer border-0 pt-0">
								<a href="history.html" class="btn btn-primary d-block btn-sm">Show more <i class="fa-solid fa-caret-right ms-2"></i></a>
							</div>
						</div>
					</div>
					<div class="col-xl-9 col-xxl-8">
