								...
								<div class="tab-pane fade show active" id="pills-Yesterday" role="tabpanel" aria-labelledby="pills-yesterday-tab">
									<div class="table-responsive">
										...
										<?php foreach ($recent_activity_yesterday as $recent_activity_y): ?>
											<tr>
												<td>    
													<?php if ($recent_activity_y['type'] == 'TopUp'): ?>
													<svg width="63" height="63" viewBox="0 0 63 63" style="padding-left: 10px" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<?php else: ?>
													<svg width="63" height="63" viewBox="0 0 63 63" fill="none" style="padding-left: 10px" xmlns="http://www.w3.org/2000/svg">
												...
												<td>
													<span class="font-w600 text-dark"><?php echo $recent_activity_y['type']; ?></span>
												</td>
												<td>
													<span class="text-dark"><?= esc($recent_activity_y['time']) ?></span>
												</td>
												<td>
													<span class="font-w600 text-dark"><?= esc($recent_activity_y['amount']) ?></span>
												</td>
												<?php if ($recent_activity_y['status'] == 'Completed'): ?>														
														<td class="text-end"><a class="btn-link text-success" href="javascript:void(0);"><?php echo $recent_activity_y['status']; ?></a></td>
												<?php elseif ($recent_activity_y['status'] == 'Failed') :?>
													<td class="text-end"><a class="btn-link text-danger" href="javascript:void(0);"><?php echo $recent_activity_y['status']; ?></a></td>
												<?php else : ?>
													<td class="text-end"><a class="btn-link text-warning" href="javascript:void(0);"><?php echo $recent_activity_y['status']; ?></a></td>
												<?php endif; ?>
											</tr>
										<?php endforeach; ?>
										</tbody>
									...
									<div class="table-responsive">
										<table class="table portfolio-table">
											<tbody>
												...
												<tr>
													<td>
														<?php if ($recent_activity['type'] == 'TopUp'): ?>
														<svg width="63" height="63" viewBox="0 0 63 63" fill="none" style="padding-left: 10px" xmlns="http://www.w3.org/2000/svg">
															<rect y="-6.10352e-05" width="63" height="63" rx="31.5" fill="#13B440"/>
															<path d="M25.4811 24.6342L25.4811 24.6342L30.3542 19.7375C30.3568 19.7348 30.3594 19.7323 30.3617 19.73M25.4811 24.6342L30.7114 20.0874L30.3584 19.7333C30.3677 19.724 30.3754 19.7171 30.3786 19.7143L30.3797 19.7133C30.3773 19.7154 30.3706 19.7213 30.3625 19.7292C30.3622 19.7295 30.362 19.7297 30.3617 19.73M25.4811 24.6342C24.9211 25.1969 24.9232 26.107 25.486 26.6671C26.0487 27.2272 26.9588 27.225 27.5189 26.6623L27.5189 26.6623L29.9375 24.2319M25.4811 24.6342L29.9375 24.2319M30.3617 19.73C30.921 19.1741 31.8276 19.1723 32.3887 19.7304C32.3899 19.7316 32.3912 19.7328 32.3924 19.7341L32.3939 19.7355L32.406 19.7477L37.2689 24.6341L36.9145 24.9868L37.2689 24.6342C37.8288 25.1968 37.8269 26.107 37.264 26.6671C36.7013 27.2271 35.7911 27.225 35.2311 26.6623L35.2311 26.6623L32.8125 24.232L32.8125 42.875C32.8125 43.6689 32.1689 44.3125 31.375 44.3125C30.5811 44.3125 29.9375 43.6689 29.9375 42.875L29.9375 24.2319M30.3617 19.73C30.3603 19.7314 30.3589 19.7328 30.3574 19.7343L29.9375 24.2319M32.3925 19.7342C32.393 19.7346 32.3934 19.7351 32.3939 19.7355L32.3925 19.7342Z" fill="white" stroke="white"/>
														</svg>
													...
													<td>
													<span class="font-w600 text-dark"><?php echo $recent_activity['type']; ?></span>
													</td>
													<td>
														<span class="text-dark"><?= esc($recent_activity['time']) ?></span>
													</td>
													<td>
														<span class="font-w600 text-dark"><?= esc($recent_activity['amount']) ?></span>
													</td>
													<?php if ($recent_activity['status'] == 'Completed'): ?>														
														<td class="text-end"><a class="btn-link text-success" href="javascript:void(0);"><?php echo $recent_activity['status']; ?></a></td>
													<?php elseif ($recent_activity['status'] == 'Failed') :?>
														<td class="text-end"><a class="btn-link text-danger" href="javascript:void(0);"><?php echo $recent_activity['status']; ?></a></td>
													<?php else : ?>
														<td class="text-end"><a class="btn-link text-warning" href="javascript:void(0);"><?php echo $recent_activity['status']; ?></a></td>
													<?php endif; ?>
												</tr>
												<?php endforeach; ?>
											</tbody>
