                ...
                <!--
                    <div class="title">
                        ...
                        <ul class="list-inline nav nav-tabs links">
                            <li class="list-inline-item nav-item"><a class="nav-link" href="shop-grid-right.html">Pharmaceuticals</a></li>
                            <li class="list-inline-item nav-item"><a class="nav-link" href="shop-grid-right.html">Nutraceuticals</a></li>
                            <li class="list-inline-item nav-item"><a class="nav-link active" href="shop-grid-right.html">Cosmetics</a></li>
                            <li class="list-inline-item nav-item"><a class="nav-link" href="shop-grid-right.html">Hospital Care</a></li>
        ...
        <div class="container">
            <!-- <div class="section-title style-2 wow animate__animated animate__fadeIn">
                ...
                <ul class="nav nav-tabs links" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="nav-tab-two" data-bs-toggle="tab" data-bs-target="#tab-two" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Pharmaceuticals</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="nav-tab-three" data-bs-toggle="tab" data-bs-target="#tab-three" type="button" role="tab" aria-controls="tab-three" aria-selected="false">Nutraceuticals</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="nav-tab-four" data-bs-toggle="tab" data-bs-target="#tab-four" type="button" role="tab" aria-controls="tab-four" aria-selected="false">Cosmetics</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="nav-tab-five" data-bs-toggle="tab" data-bs-target="#tab-five" type="button" role="tab" aria-controls="tab-five" aria-selected="false">Hospital Care</button>
                    </li>
                    <li class="nav-item" role="presentation">
                                                    ...
                                                    <div class="product-cart-wrap">
                                                        ...
                                                        <div class="product-content-wrap">
                                                            ...
                                                            <div class="sold mt-15 mb-15">
                                                                ...
                                                                <span class="font-xs text-heading"> Sold: <?php echo $product['sold_units']; ?>/<?php echo $product['total_units']; ?></span>
                                                            </div>
                                                ...
                                                <div class="product-cart-wrap">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        ...
                                                        <div class="sold mt-15 mb-15">
                                                            ...
                                                            <span class="font-xs text-heading"> Sold: 70/120</span>
                                                        </div>
                                                        <a href="shop-cart.html" class="btn w-100 hover-up"><i class="fi-rs-shopping-cart mr-5"></i>Add To Cart</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="product-cart-wrap">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        ...
                                                        <div class="sold mt-15 mb-15">
                                                            ...
                                                            <span class="font-xs text-heading"> Sold: 93/120</span>
                                                        </div>
                                                        <a href="shop-cart.html" class="btn w-100 hover-up"><i class="fi-rs-shopping-cart mr-5"></i>Add To Cart</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="product-cart-wrap">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        ...
                                                        <div class="sold mt-15 mb-15">
                                                            ...
                                                            <span class="font-xs text-heading"> Sold: 81/120</span>
                                                        </div>
                                                        <a href="shop-cart.html" class="btn w-100 hover-up"><i class="fi-rs-shopping-cart mr-5"></i>Add To Cart</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="product-cart-wrap">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        ...
                                                        <div class="sold mt-15 mb-15">
                                                            ...
                                                            <span class="font-xs text-heading"> Sold: 111/120</span>
                                                        </div>
                                                        <a href="shop-cart.html" class="btn w-100 hover-up"><i class="fi-rs-shopping-cart mr-5"></i>Add To Cart</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="product-cart-wrap">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        ...
                                                        <div class="sold mt-15 mb-15">
                                                            ...
                                                            <span class="font-xs text-heading"> Sold: 98/120</span>
                                                        </div>
                                                        <a href="shop-cart.html" class="btn w-100 hover-up"><i class="fi-rs-shopping-cart mr-5"></i>Add To Cart</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="product-cart-wrap">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        ...
                                                        <div class="sold mt-15 mb-15">
                                                            ...
                                                            <span class="font-xs text-heading"> Sold: 69/120</span>
                                                        </div>
                                                        <a href="shop-cart.html" class="btn w-100 hover-up"><i class="fi-rs-shopping-cart mr-5"></i>Add To Cart</a>
                                                    </div>
                                                </div>
                        ...
                        <img class="default-img" src="<?php echo base_url('/' . $product['thumbnail']); ?>" alt="<?php echo $product['ProductName']; ?>" />
                                        ...
                                        <div class="product-content-wrap">
                                            <div class="deals-countdown-wrap">
                                                <!-- Replace with a dynamic countdown if you have one -->
                            ...
                            <?php 
                                echo strlen($product['TherapeuticUse']) > 100
                                    ? substr($product['TherapeuticUse'], 0, 100) . '...' 
                                    : $product['TherapeuticUse']; 
                            ?> 
                            <a href="vendor-details-1.html">Read More</a>
                        </span>
                                                </div>
                                                <div class="product-card-bottom">
                                                    <div class="product-price">
                                                        <span><?php echo $product['Content']; ?></span>
                                                        <!-- <span class="old-price"><?php echo $product['DosageForm']; ?></span> -->
                                                    </div>
                                                    <div class="add-cart">
                                    ...
                                    <?php foreach ($topSellingProducts as $product): ?>
                                        <article class="row align-items-center hover-up">
                                            <figure class="col-md-4 mb-0">
                                                <a href="shop-product-right.html">
                <img src="<?php echo base_url('/' . $product['thumbnail']); ?>" alt="<?php echo $product['ProductName']; ?>" />
            </a>
                                            </figure>
                                            <div class="col-md-8 mb-0">
                                                <h6>
                <a href="shop-product-right.html"><?php echo $product['ProductName']; ?></a>
            </h6>
                                                <div class="product-rate-cover">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width: <?php echo ($product['rating'] / 5) * 100; ?>%"></div>
