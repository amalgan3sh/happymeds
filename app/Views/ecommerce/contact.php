       ...
       <div class="header">
									...
									<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
										<div class="header-info2 d-flex align-items-center">
											<div class="d-flex align-items-center sidebar-info">
												<div>
													<h4 class="text-white mb-1">Milan Khadia</h4>
													<span class="d-block text-end">@milankhadia12</span>
												</div>
											</div>
			...
			<div class="page-titles">
				<div class="d-flex align-items-center">
					<h2 class="text-white">Portofolio</h2>
					<p class="text-warning ms-2">Welcome Back Milan Khadia !</p>
				</div>
				<ol class="breadcrumb">
					<li class="breadcrumb-item active ms-auto">
						<a class="d-flex align-self-center" href="ecommerce_home">
				...
				<div class="row">
							...
							<div class="card-body">
								<div class="text-center my-profile">
									<div class="media d-block">
										...
										<h3 class="mt-3 font-w800 text-dark">Shynesh Moolayi</h3>
										<span>shyneshmoolayi.aranea.in</span>
									</div>
									<div class="media-content">
										<h4 class="mt-3 font-w400 fs-16 text-dark mb-0">(+91) 9744334141</h4>
										<p class="my-3">10:00 - 18:00, Mon - Sat</p>
									</div>
                    ...
                    <div class="container">
                        ...
                        <form action="/submit-form" method="POST">
                            ...
                            <button style="background-color: blue; color: white; padding: 10px 20px; border: none; border-radius: 4px;">
                                Submit
                            </button></center>
                        </form>
                    </div>
