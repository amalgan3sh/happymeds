        ...
        <div class="row row--30">
            <div class="col-lg-8">
                <div class="rainbow-collaboration-details-area">
                    ...
                    <div class="collaboration-details-content pt--40 rainbow-section-gapBottom">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="content">
            ...
            <div class="col-lg-4 mt_md--40 mt_sm--40">
                <aside class="rainbow-sidebar">
                    ...
                    <div class="rbt-single-widget widget_categories mt--40">
                        ...
                        <div class="inner">
                            <ul class="category-list">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="left-content">Business Innovation</span>
                    ...
                    <div class="rbt-single-widget widget_recent_entries mt--40">
                        <h3 class="title">Recent Collaborations</h3>
                        <div class="inner">
                            <ul>
                                <li>
...
<!-- End Collaboration Opportunities Section -->