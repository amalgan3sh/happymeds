            ...
            <div class="col-lg-3 col-md-6">
                <div class="card shadow-lg mb-4 border-0">
                    ...
                    <div class="card-body mx-auto">
                        ...
                        <a class="btn btn-lg btn-primary rounded-pill mb-3" style="background-color: #FCAE61 !important; border-color: #FFFFFF !important;" href="<?php echo base_url('register_supplier'); ?>">Register Now</a>
                        <a class="btn btn-lg btn-primary rounded-pill mb-3" href="<?php echo base_url('supplier_login'); ?>">Log in</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
