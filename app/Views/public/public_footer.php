                ...
                <!-- <div class="col-lg-2 col-md-6 col-sm-6 col-12">
                    <div class="rainbow-footer-widget">
                        <div class="widget-menu-top">
                            ...
                            <div class="inner">
                                <ul class="footer-link link-hover">
                                    <li><a href="healthcare.html">Healthcare Solutions</a></li>
                                    <li><a href="realestate.html">Real Estate Solutions</a></li>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-4 col-sm-12 col-12">
                <div class="copyright-right text-center text-lg-end">
                    <p class="copyright-text">Copyright © 2024 <a href="#" class="btn-read-more"><span>ARANEA.</span></a> All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
